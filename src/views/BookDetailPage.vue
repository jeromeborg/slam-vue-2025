    ...
    <main class="container mx-auto px-6 py-12">
      ...
      >
        ...
        <div class="mb-8 space-y-2">
          ...
          <p class="text-white/90 text-xl">
            <span class="font-semibold">Price:</span> {{ book.price }}
          </p>
        </div>
        ...
        <div class="mt-8 flex gap-4">
          <button
            class="px-8 py-3 bg-white text-emerald-600 font-semibold rounded-lg hover:bg-emerald-50 transition-all duration-300 transform hover:scale-105"
          >
            Borrow Book
          </button>
          <button
            class="px-8 py-3 bg-white/20 text-white font-semibold rounded-lg hover:bg-white/30 transition-all duration-300 transform hover:scale-105"
          >
            Add to Favorites
          </button>
        </div>
